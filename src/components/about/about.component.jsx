            ...
            <div className='about-section'>
                <Fade bottom>
                    ...
                    <p className='about-paragraph'>
                        I am a Ruby on Rails Engineer with almost three years of hands-on experience in developing robust web applications. I'm a Computer Science graduate from Babes-Bolyai University, currently pursuing a master's degree in Entrepreneurship and Business Administration. <br /> <br />
